...
#' 10,128 baits in HEK293T cell lines. See the source for more details about included columns.
#' @format A data.frame with 883,356 rows and 4 variables:
#' \describe{
...
#' @family datasets
#' @docType data
#' @source See cited references; downloaded 4-Jan-2021 from \url{https://bioplex.hms.harvard.edu/interactions.php}.
#' @references
...
#' @title IRefIndex 17.0 interaction database
#' @description A data set containing 396,984 unique protein-protein interactions for human 17,437 genes.
...
#' }
#' @details This data set was generated by first excluding all non-binary and non-human interactions. HGNC
#' gene names were then extracted from the database. The 5 relevant columns were selected. This resulted
#' in duplicate rows. These were removed, and the scores with the max values were kept. 
#' 
#' @family datasets
#' @docType data
