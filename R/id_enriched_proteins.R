#' @title Identify significant proteins
#' @description Identify significant proteins based in input thresholds.
#' @param df data.frame containing logFC, pvalue, and FDR columns
...
#' @return data.frame containing df + signficanct column of boolean values indicating which 
#' df rows (proteins) are significant according to FDR correction.
#' @export

id_significant_proteins <- function(df, logfc_dir="positive", logfc_cutoff=NULL, p_cutoff=NULL, fdr_cutoff=0.1){
...
id_enriched_proteins <- function(df, logfc_dir="positive", logfc_cutoff=NULL, p_cutoff=NULL, fdr_cutoff=0.1){
  ...
  warning('"id_enriched_proteins" is deprecated and will be removed in a future release. Please, use "id_significant_proteins".')
